...
function PredictionPlaceholder() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-900 to-purple-950/20 p-6">
      {/* Ambient glow */}
      ...
      <div className="relative">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Analýza a predpovede vývoja trhu</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-slate-400">Predikcia 6M</span>
            </div>
          ...
          <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-slate-400">Predikcia 1Y</span>
            </div>
            <div className="h-8 bg-slate-700/50 rounded animate-pulse" />
          </div>
        </div>
