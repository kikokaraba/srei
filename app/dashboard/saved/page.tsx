...
export default function SavedPropertiesPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Hero Header */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-900 to-rose-950/30 p-6 lg:p-8">
        {/* Ambient glow */}
          ...
          {selectedPropertyId ? (
            ...
            <div className="p-6 h-full min-h-[400px] flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-slate-400 font-medium">Vyberte nehnuteľnosť</p>
                <p className="text-sm text-slate-500 mt-1">Pre zobrazenie cenovej histórie</p>
              </div>
            </div>
          )}
        </div>
