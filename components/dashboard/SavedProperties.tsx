    ...
    <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-6">
      ...
      {savedProperties.length === 0 ? (
        <div className="text-center py-8">
          ...
          <p className="text-zinc-400 mb-2">Žiadne uložené nehnuteľnosti</p>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <span className="text-zinc-200">{saved.property.area_m2} m²</span>
                      </div>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className={`p-2 rounded-lg transition-colors ${
                        saved.isFavorite
                          ...
                          : "bg-zinc-700/50 text-zinc-400 hover:text-red-400"
                      }`}
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg bg-zinc-700/50 text-zinc-400 hover:text-red-400 transition-colors"
