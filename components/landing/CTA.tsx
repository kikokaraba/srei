        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="glass-card rounded-3xl p-8 sm:p-12 lg:p-16 text-center glow-emerald-soft">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center items-center mb-12">
              ...
              <Link
                href="#pricing"
                className="w-full sm:w-auto px-10 sm:px-14 py-5 sm:py-6 glass hover:bg-slate-800/80 text-white font-semibold rounded-2xl transition-all duration-300 border border-slate-600 hover:border-emerald-500/50 text-center"
              >
                Zobraziť cenník
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-3xl mx-auto">
              <div className="flex flex-col items-center gap-2 p-4 rounded-xl glass-light">
                ...
                <p className="text-sm text-slate-300 font-medium">Okamžitý prístup</p>
              </div>
              <div className="flex flex-col items-center gap-2 p-4 rounded-xl glass-light">
                <div className="w-10 h-10 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center">
                  <Shield className="w-5 h-5 text-emerald-400" />
                </div>
                <p className="text-sm text-slate-300 font-medium">100% bezpečné</p>
              </div>
              <div className="flex flex-col items-center gap-2 p-4 rounded-xl glass-light">
                <div className="w-10 h-10 rounded-lg bg-gold-500/10 border border-gold-500/20 flex items-center justify-center">
                  <CreditCard className="w-5 h-5 text-gold-400" />
                </div>
                <p className="text-sm text-slate-300 font-medium">Žiadna karta</p>
              </div>
              <div className="flex flex-col items-center gap-2 p-4 rounded-xl glass-light">
                <div className="w-10 h-10 rounded-lg bg-slate-700/50 border border-slate-600 flex items-center justify-center">
                  <RotateCcw className="w-5 h-5 text-slate-400" />
                </div>
                <p className="text-sm text-slate-300 font-medium">Zrušiteľné</p>
              </div>
            </div>
          </div>
        </div>
