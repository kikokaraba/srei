...
export const REGIONS: Record<string, Region> = {
  BA: {
    ...
    slug: "bratislavsky",
    type: "region",
    districts: ["BA1", "BA2", "BA3", "BA4", "BA5", "MA", "PE", "SE"],
  },
  TT: {
    id: "TT",
    name: "Trnavský kraj",
    slug: "trnavsky",
    type: "region",
    districts: ["DS", "GA", "HC", "PN", "SE", "SK", "TT"],
  },
  TN: {
    id: "TN",
    ...
    slug: "trenciansky",
    type: "region",
    districts: ["BN", "IL", "MY", "NM", "PE", "PB", "PU", "TN"],
  },
  NR: {
    id: "NR",
    ...
    slug: "nitriansky",
    type: "region",
    districts: ["KN", "LV", "NR", "NZ", "SA", "TO", "ZM"],
  },
  ZA: {
    id: "ZA",
    name: "Žilinský kraj",
    slug: "zilinsky",
    type: "region",
    districts: ["BY", "CA", "DK", "KM", "LM", "MT", "NO", "RK", "TR", "TS", "ZA"],
  },
  BB: {
    id: "BB",
    ...
    type: "region",
    districts: ["BB", "BR", "BS", "DT", "KA", "LC", "PT", "RA", "RS", "VK", "ZC", "ZH", "ZV"],
  },
  PO: {
    id: "PO",
    name: "Prešovský kraj",
    slug: "presovsky",
    type: "region",
    districts: ["BJ", "HE", "KK", "LE", "ML", "PO", "PP", "SB", "SK", "SL", "SN", "SP", "SV", "VT"],
  },
  KE: {
    id: "KE",
    name: "Košický kraj",
    slug: "kosicky",
    type: "region",
    districts: ["GE", "KE1", "KE2", "KE3", "KE4", "KS", "MI", "RV", "SO", "SP", "TV"],
  },
};
